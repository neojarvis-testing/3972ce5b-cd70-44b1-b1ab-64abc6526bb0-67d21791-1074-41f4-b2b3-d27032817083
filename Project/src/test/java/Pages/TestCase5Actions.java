...
     */
    ...
    public void completeTestCase5(){
        clickOnHelp_ClickOnOrderRelated(Hooks.test);
        NavigateAnd_ClickOnCancelletionsAndRefund(Hooks.test);
        clickOnCancellationPolicy_ClickOnLinkSwitchWindow(Hooks.test);
    }     
...
     */
    ...
    public void userOnCancellation(ExtentTest test){
        Screenshot.captureScreenshot(Base.driver, test, "Help Center");
