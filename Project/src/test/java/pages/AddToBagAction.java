 ...
 * @author Harshit
 */
    public static void sendPincode(ExtentTest test , String string) {
        try {
            Thread.sleep(2000);
           
            driverHelper.sendKeys(AddToBagPageLoc.clickPincode, string, test, "placeholder");
        } catch (Exception e) {
            LoggerHandler.info(e.getMessage());
        }
    }
 ...
 * @author Harshit
 */
    public static void allAddToBag(ExtentTest test , String string) {
        
        clickPincodeSearch(test);
        sendPincode(test , string);
