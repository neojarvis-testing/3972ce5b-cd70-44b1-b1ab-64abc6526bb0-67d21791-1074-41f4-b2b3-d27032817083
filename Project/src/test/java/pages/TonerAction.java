...
public class TonerAction {
    ...
    public static void tonerDisplayed(ExtentTest test) {
     ...
     /**
     * Description: Verifies if the "inclusive of all taxes" under mrp element is displayed on the page.
     *
     * @param test ExtentTest object for logging and reporting.
     * @return void
     * @author Harshit
     */
    public static void incluseMrpDisplayed(ExtentTest test) {
        try {
            driverHelper.isElementDisplayed(AddToBagPageLoc.inclusiveDisplayed, test);
    ...
    /**
     * Description: Executes a sequence of actions related to the "Toner" workflow,
     * including inclusive verified and clicking on the first product.
     *
     * @param test ExtentTest object for logging and reporting.
     * @return void
     * @author Harshit
     */
    public static void clikcFirstProductAndInclusive(ExtentTest test){
        clickOnFirstProduct(test);
        incluseMrpDisplayed(test);
    }
