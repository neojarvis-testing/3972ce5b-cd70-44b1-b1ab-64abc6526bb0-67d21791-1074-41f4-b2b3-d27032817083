...
public class HomePageNavbarAction {
     ...
     * @author Harshit
     */
    public static void sendKeyToSearchBar(ExtentTest test , String string) {
        try {
            driverHelper.sendKeys(HomePageNavbarLoc.searchBar, string, test, "placeholder");
     ...
     * @author Harshit
     */
    public static void navbarAll(ExtentTest test , String string) {
        clickSearchBar(test);
        sendKeyToSearchBar(test , string);
        enterSearchBar(test);
    }
